            ...
            <div className="hidden lg:flex items-center space-x-1">
              {menuItems.map((item) => (
                ...
                >
                  ...
                  {/* 진료과목 메가 메뉴 */}
                  {item.id === 'services' && item.hasSubmenu && hoveredMenu === item.id && (
                    <div 
                              ...
                              {item.id === 'services' ? (
                                ...
                                categoryMap.map((category) => (
                                  <div key={category.id} className="space-y-1">
                                    <div className="flex items-center space-x-2 py-2 px-3 text-sm font-medium text-gray-600">
                                    ...
                                    <div className="ml-6 space-y-1">
                                      {category.treatments.map((treatment) => (
                                        <button
                                          key={treatment.id}
                                          onClick={() => handleNavClick(treatment.id)}
